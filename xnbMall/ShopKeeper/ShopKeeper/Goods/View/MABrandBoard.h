...
@protocol MABrandBoardDelegate <NSObject>

- (void)brandBoardSelectedItemAtItem:(NSInteger)item;

@end

@interface MABrandBoard : JKView

@property (nonatomic, unsafe_unretained) id <MABrandBoardDelegate> delegate;
