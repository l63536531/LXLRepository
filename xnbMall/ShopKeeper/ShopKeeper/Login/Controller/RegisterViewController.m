...
-(UIView*)viewforheader {
    ...
    
    {
        ...
        [textPhone setFont:[UIFont systemFontOfSize:14]];
        [textPhone setContentVerticalAlignment : UIControlContentVerticalAlignmentCenter];
        [textPhone setTextColor:ColorFromHex(0x646464)];
    ...
    
    {
        ...
        [textPwdnow setFont:[UIFont systemFontOfSize:14]];
        ...
        [textPwdnow setKeyboardType:UIKeyboardTypeNumbersAndPunctuation];
    ...
    
    {
        ...
        [textPwdnew setFont:[UIFont systemFontOfSize:14]];
...
-(void)BtnClicked:(id)sender{
    ...
    [[NetWorkManager shareManager]netWWorkWithReqUrl:@"login/register.do" ReqParam:postdata BoolForTooken:YES PresentLogionController:self CallBack:^(NetResult result, NSDictionary *dicStr, BOOL fail_success) {
