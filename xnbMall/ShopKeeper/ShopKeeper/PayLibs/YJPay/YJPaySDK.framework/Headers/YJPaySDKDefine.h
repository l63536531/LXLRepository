...
// 实体类型(2017-03-07 新增[可选值：个人/企业])
FOUNDATION_EXPORT NSString *kYJPayEntityType;
FOUNDATION_EXPORT NSString *YJPayEntityPersonal;    // 个人[默认]
FOUNDATION_EXPORT NSString *YJPayEntityEnterprise;  // 企业
FOUNDATION_EXPORT NSString *YJPayEntityIndividual;  // 个体户
