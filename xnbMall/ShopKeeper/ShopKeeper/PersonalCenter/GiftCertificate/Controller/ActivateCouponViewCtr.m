...
@interface ActivateCouponViewCtr ()
...
@implementation ActivateCouponViewCtr
...
{//UITableViewCell 1
    ...
    NSLog(@"%f+++%f++%f",self.tableOffset,SCREEN_HEIGHT,keyboardHeigh);
    ...
    if (offset>0) {
        ...
        [UIView animateWithDuration:duration animations:^{
            mianTableView.contentInset = UIEdgeInsetsMake(0, 0, keyboardHeigh, 0);
...
//    [cell.contentView addSubview:line];
    ...
    switch (indexPath.row) {
            ...
            
        {
            ...
            line.frame = CGRectMake(0, SCREEN_WIDTH/9*6 - 1, SCREEN_WIDTH, 1);
        ...
        {
            cashcoupontext = [self createTextField:CGRectMake(0, 0, SCREEN_WIDTH , 50) placeholder:@"请输入您的礼券激活码" SecureTextEntry:NO];
...
-(void)buttonclick:(id)sender{
    ...
    if (textstring.length>0) {
        [[TransDataProxyCenter shareController] giftcardactivatecode:textstring block:^(NSDictionary *dic, NSError *error) {
