...
@interface PreferentialRecordCell()
...
@implementation PreferentialRecordCell
...
-(void)layoutSubviews{
    ...
    BOOL isPerfix = [[_titlearray objectAtIndex:2] hasPrefix:@"-"];
    if (isPerfix) {
        [self.moneylabel setTextColor:[UIColor greenColor]];
