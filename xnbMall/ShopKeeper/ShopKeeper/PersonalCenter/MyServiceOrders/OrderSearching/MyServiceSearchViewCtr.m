...
@interface MyServiceSearchViewCtr ()
@property(nonatomic , strong)UISearchBar * bar;

@end

@implementation MyServiceSearchViewCtr
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar{
    ...
    MyServiceSearchEndCtr *vc = [[MyServiceSearchEndCtr alloc] init];
