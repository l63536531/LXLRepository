...
@end
@implementation MoneyFlowingCell
...
-(void)layoutSubviews{
    ...
    [self.accountlabel setText:[NSString stringWithFormat:@"%@",_flowingmondel.flowType]];
    ...
    [self.timelabel setText:[NSString stringWithFormat:@"%@",_flowingmondel.createdDate]];
    ...
    [self.moneylabel setText:[NSString stringWithFormat:@"%0.2f",_flowingmondel.amount.floatValue]];
    if (_flowingmondel.amount.floatValue<0) {
        [self.moneylabel setTextColor:ColorFromRGB(100, 173, 75)];
    ...
    NSString* labtext =[NSString stringWithFormat:@"余额：%.2f",[_flowingmondel.accountBalance floatValue]] ;
    ...
    [self.servicelabel setText:[NSString stringWithFormat:@"备注：%@",_flowingmondel.notes]];
