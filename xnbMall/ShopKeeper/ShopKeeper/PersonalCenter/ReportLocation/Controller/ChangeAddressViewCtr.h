...
@interface ChangeAddressViewCtr : UIViewController<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,UITextViewDelegate,UIGestureRecognizerDelegate,UITextViewDelegate,UIPopoverPresentationControllerDelegate,UIAlertViewDelegate>{
