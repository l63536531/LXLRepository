...
#define kCollectionViewBarHieght 50
...
- (void)configireTabPropertys
{
    ...
    _normalTextFont = [UIFont systemFontOfSize:13];
    _selectedTextFont = [UIFont systemFontOfSize:13];
...
- (void)layoutTabPagerView
{
    ...
    _pagerBarView.frame = CGRectMake(15, 0, CGRectGetWidth(self.view.frame)-30, self.contentTopEdging+[self statusBarHeight]);
    _collectionViewBar.frame = CGRectMake(0, [self statusBarHeight], CGRectGetWidth(self.view.frame)-30, self.contentTopEdging);
}
